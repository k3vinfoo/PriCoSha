...
CREATE TABLE Tag(
	...
	FOREIGN KEY (username_tagger) REFERENCES Person(username) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (username_taggee) REFERENCES Person(username) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE Member(
	...
	FOREIGN KEY (username) REFERENCES Person(username) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (group_name, username_creator) REFERENCES FriendGroup(group_name, username) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
FOREIGN KEY (id) REFERENCES Content(id) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (group_name, username) REFERENCES FriendGroup(group_name, username) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
